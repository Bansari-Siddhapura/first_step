        ...
        <div
            ...
            <ul
                ...
                <li class="dropdown">
                    <button
                        class="dropdown-toggle flex w-full items-center border-b border-gray-800 py-2 px-3 font-medium md:border-0 md:p-0">
                        <i class="ti ti-template mr-1 pb-1 text-lg"></i><a href="{{ route('items.show')}}">Item Management</a> </button>
                </li>
            </ul>
        </div>
        <div class="order-1 ml-auto flex items-center md:order-2">
            ...
            <div class="mr-2 lg:mr-0 dropdown relative">
                ...
                <div
                    ...
                    <div class="py-3 px-4">
                        <span
                            class="block text-sm font-medium text-gray-900 dark:text-white">Bonnie Green</span>
                        <span
                    ...
                    <ul class="py-1" aria-labelledby="navUserdata">
                        ...
                        <li>
                            <a
                                href="#"
                                class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-900/20 dark:hover:text-white">Sign out</a>
                        </li>
                    </ul>
                </div>
            </div>
